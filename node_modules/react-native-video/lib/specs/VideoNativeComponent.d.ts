...
type DRMType = WithDefault<'widevine' | 'playready' | 'clearkey' | 'fairplay', 'widevine'>;
...
type SelectedTextTrackType = WithDefault<'system' | 'disabled' | 'title' | 'language' | 'index', 'system'>;
type SelectedAudioTrackType = WithDefault<'system' | 'disabled' | 'title' | 'language' | 'index', 'system'>;
...
type SelectedVideoTrackType = WithDefault<'auto' | 'disabled' | 'resolution' | 'index', 'auto'>;
...
export interface VideoNativeProps extends ViewProps {
    ...
    muted?: boolean;
    controls?: boolean;
    filter?: WithDefault<'' | 'CIColorInvert' | 'CIColorMonochrome' | 'CIColorPosterize' | 'CIFalseColor' | 'CIMaximumComponent' | 'CIMinimumComponent' | 'CIPhotoEffectChrome' | 'CIPhotoEffectFade' | 'CIPhotoEffectInstant' | 'CIPhotoEffectMono' | 'CIPhotoEffectNoir' | 'CIPhotoEffectProcess' | 'CIPhotoEffectTonal' | 'CIPhotoEffectTransfer' | 'CISepiaTone', ''>;
